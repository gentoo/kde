...
IUSE="+addbookmarks +alias +autoreplace +contactnotes debug gadu groupwise
	+highlight +history htmlhandbook +jabber latex +msn messenger msn
	+nowlistening +oscar +otr +privacy qq sms ssl +statistics testbed telepathy
	+texteffect +translator +urlpicpreview +webpresence winpopup yahoo"
# IUSE="irc jingle meanwhile"

# plugins: addbookmarks, alias, autoreplace, contactnotes, highlight, history,
# 		latext, nowlistening, otr, privacy, (sqlite?) statistics, texteffect, translator,
