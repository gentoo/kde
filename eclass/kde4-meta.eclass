		...
		kdebase-workspace)
			...
			if [[ ${PN} != libkworkspace ]]; then
				sed -i \
					...
					-e"s/FILE[[:space:]]KDE4WorkspaceLibraryTargets.cmake/FILE[[:space:]]KDE4WorkspaceLibraryTargets.cmake[[:space:]]RENAME[[:space:]]KDE4WorkspaceLibraryTargets-${PN}.cmake/g" \
