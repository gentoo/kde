...
LICENSE="GPL-2"
IUSE="addressbook calendar dnn gphoto2 jpeg2k +lensfun libav marble mediaplayer mysql opengl openmp +panorama scanner semantic-desktop vkontakte webkit X"
